...
const THEME_KEY = 'parkReports_theme';
...
function deleteUserAccount() {
  ...
  const usersData = localStorage.getItem(AUTH_STORAGE_KEY);
  if (usersData) {
  ...
  const updatedReports = allReports.filter(r => r.authorId !== currentUser.id);
...
function deleteAccount() {
  const confirmation = confirm(
    "Are you sure you want to delete your account? This action cannot be undone and will permanently delete all your reports and data."
  );
