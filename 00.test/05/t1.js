...
//   const leaves = document.querySelectorAll('#plantSvg .leaf path');
//   const flowerParts = document.querySelectorAll('#flower circle');
...
//       setTimeout(() => {
//         part.style.transition = 'opacity 0.6s ease-out';
